...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('3 Month Return Percent'); ?></th>
		<th><?php echo __('Ytd Return Percent'); ?></th>
		<th><?php echo __('3 Yr Return Percent'); ?></th>
		<th><?php echo __('5 Yr Return Percent'); ?></th>
		<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($customer['Mutualfund'] as $mutualfund): ?>
		<tr>
			...
			<td><?php echo $mutualfund['3_month_return_percent']; ?></td>
			<td><?php echo $mutualfund['ytd_return_percent']; ?></td>
			<td><?php echo $mutualfund['3_yr_return_percent']; ?></td>
			<td><?php echo $mutualfund['5_yr_return_percent']; ?></td>
			<td class="actions">
